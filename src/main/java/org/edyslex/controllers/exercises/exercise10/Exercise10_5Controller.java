...
public class Exercise10_5Controller extends ExerciseBaseController implements Initializable {
    ...
    private List<String> tags = new ArrayList<String>(Arrays.asList(
            "o să mă dau cu sa-ni-a.", "o să în-ghe-țe la-cul.", "o să și tu-ne.",
            "o să fa-cem gem.", "o să stră-lu-ceas-că sti-cla.",
            "o să mă-nânc spa-ghe-te.", "o să vă ghe-par-dul.", "o să mă-nânc în-ghe-ța-tă."));
    ...
    public void initialize(URL arg0, ResourceBundle arg1){
        ...
        labelsMap.put(lbl1, "o să mă dau cu sa-ni-a.");
        labelsMap.put(lbl2, "o să în-ghe-țe la-cul.");
        labelsMap.put(lbl3, "o să și tu-ne.");
        labelsMap.put(lbl4, "o să fa-cem gem.");
        labelsMap.put(lbl5, "o să stră-lu-ceas-că sti-cla.");
        labelsMap.put(lbl6, "o să mă-nânc spa-ghe-te.");
        labelsMap.put(lbl7, "o să vă ghe-par-dul.");
        labelsMap.put(lbl8, "o să mă-nânc în-ghe-ța-tă.");
    ...
    public void reset(ActionEvent event) throws IOException {
        switchScene(event, "scenes/exercises/exercise10/exercise10_5.fxml");
    }
