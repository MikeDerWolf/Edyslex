...
public class Exercise11_4Controller extends ExerciseBaseController implements Initializable {
    ...
    private List<String> tags = new ArrayList<String>(Arrays.asList(
            "om-le-tă", "mu-sa-ca", "su-pă", "frip-tu-ră", "spa-ghe-te", "plă-cin-tă", "pa-ti-ne", "min-ge", "schi-uri",
            "mă-nuși de box", "sa-ni-e", "disc", "mor-tar", "ni-sip", "că-ră-mi-dă", "ți-glă", "pia-tră", "scân-du-ră"));

    private List<String> wordsColumn1 = new ArrayList<String>(Arrays.asList(
            "om-le-tă", "mu-sa-ca", "su-pă", "frip-tu-ră", "spa-ghe-te", "plă-cin-tă"));

    private List<String> wordsColumn2 = new ArrayList<String>(Arrays.asList(
            "pa-ti-ne", "min-ge", "schi-uri", "mă-nuși de box", "sa-ni-e", "disc"));

    private List<String> wordsColumn3 = new ArrayList<String>(Arrays.asList(
            "mor-tar", "ni-sip", "că-ră-mi-dă", "ți-glă", "pia-tră", "scân-du-ră"));
    ...
    public void reset(ActionEvent event) throws IOException {
        switchScene(event, "scenes/exercises/exercise11/exercise11_4.fxml");
    }
