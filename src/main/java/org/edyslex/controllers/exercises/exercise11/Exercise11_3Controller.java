...
public class Exercise11_3Controller extends ExerciseBaseController implements Initializable {
    ...
    private List<String> tags = new ArrayList<String>(Arrays.asList(
            "bi-ci-cle-tă", "tram-vai", "bar-că", "mo-to-ci-cle-tă", "ma-și-nă", "a-u-to-buz", "me-re", "a-fi-ne",
            "por-to-ca-lă", "lă-mâ-ie", "pe-pe-ne", "pa-ră", "ceai", "li-mo-na-dă", "lap-te", "suc", "apă", "ca-fea"));

    private List<String> wordsColumn1 = new ArrayList<String>(Arrays.asList(
            "bi-ci-cle-tă", "tram-vai", "bar-că", "mo-to-ci-cle-tă", "ma-și-nă", "a-u-to-buz"));

    private List<String> wordsColumn2 = new ArrayList<String>(Arrays.asList(
            "me-re", "a-fi-ne", "por-to-ca-lă", "lă-mâ-ie", "pe-pe-ne", "pa-ră"));

    private List<String> wordsColumn3 = new ArrayList<String>(Arrays.asList(
            "ceai", "li-mo-na-dă", "lap-te", "suc", "apă", "ca-fea"));
    ...
    public void reset(ActionEvent event) throws IOException {
        switchScene(event, "scenes/exercises/exercise11/exercise11_3.fxml");
    }
