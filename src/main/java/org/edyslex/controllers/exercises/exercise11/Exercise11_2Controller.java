...
public class Exercise11_2Controller extends ExerciseBaseController implements Initializable {
    ...
    private List<String> tags = new ArrayList<String>(Arrays.asList(
            "min-ge", "ti-ti-rez", "ur-su-leț", "tre-nu-leț", "pă-pu-șă", "ma-și-nu-ță", "fus-tă", "că-ma-șă",
            "gea-că", "șo-se-te", "blu-ză", "ro-chi-e", "co-roa-nă", "cer-cei", "lăn-ți-șor", "măr-ge-le", "i-nel",
            "bră-ța-ră"));

    private List<String> wordsColumn1 = new ArrayList<String>(Arrays.asList(
            "min-ge", "ti-ti-rez", "ur-su-leț", "tre-nu-leț", "pă-pu-șă", "ma-și-nu-ță"));

    private List<String> wordsColumn2 = new ArrayList<String>(Arrays.asList(
            "fus-tă", "că-ma-șă", "gea-că", "șo-se-te", "blu-ză", "ro-chi-e"));

    private List<String> wordsColumn3 = new ArrayList<String>(Arrays.asList(
            "co-roa-nă", "cer-cei", "lăn-ți-șor", "măr-ge-le", "i-nel", "bră-ța-ră"));
    ...
    public void reset(ActionEvent event) throws IOException {
        switchScene(event, "scenes/exercises/exercise11/exercise11_2.fxml");
    }
