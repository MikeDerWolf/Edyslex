...
public class Exercise11_6Controller extends ExerciseBaseController implements Initializable {
    ...
    private List<String> tags = new ArrayList<String>(Arrays.asList(
            "cre-ion", "sti-lou", "ca-ri-o-că", "ca-iet", "ra-di-e-ră", "ri-glă", "pi-per", "scor-ți-șoa-ră", "sa-re",
            "cu-i-șoa-re", "va-ni-li-e", "bo-ia", "vra-bi-e", "struț", "le-bă-dă", "cio-câr-li-e", "vul-tur",
            "rân-du-ni-că"));

    private List<String> wordsColumn1 = new ArrayList<String>(Arrays.asList(
            "cre-ion", "sti-lou", "ca-ri-o-că", "ca-iet", "ra-di-e-ră", "ri-glă"));

    private List<String> wordsColumn2 = new ArrayList<String>(Arrays.asList(
            "pi-per", "scor-ți-șoa-ră", "sa-re", "cu-i-șoa-re", "va-ni-li-e", "bo-ia"));

    private List<String> wordsColumn3 = new ArrayList<String>(Arrays.asList(
            "vra-bi-e", "struț", "le-bă-dă", "cio-câr-li-e", "vul-tur", "rân-du-ni-că"));
    ...
    public void reset(ActionEvent event) throws IOException {
        switchScene(event, "scenes/exercises/exercise11/exercise11_6.fxml");
    }
