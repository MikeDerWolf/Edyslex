...
public class Exercise2_3Controller extends ExerciseBaseController implements Initializable {
    ...
    private List<String> words = new ArrayList<String>(Arrays.asList(
            "bambus", "cactus", "păstor", "carton", "pervaz", "nervos", "cartof", "pescar",
            "pictor", "zumzet", "nectar", "șampon"));

    private List<String> tags = new ArrayList<String>(Arrays.asList(
            "bam", "bus", "cac", "tus", "păs", "tor", "car", "ton",
            "per", "vaz", "ner", "vos", "car", "tof", "pes", "car",
            "pic", "tor", "zum", "zet", "nec", "tar", "șam", "pon"));

    private List<String> leftSideTags = new ArrayList<String>(Arrays.asList(
            "bam", "cac", "păs", "car", "per", "ner", "car", "pes", "pic", "zum", "nec", "șam"));

    private List<String> rightSideTags = new ArrayList<String>(Arrays.asList(
            "bus", "tus", "tor", "ton", "vaz", "vos", "tof", "car", "tor", "zet", "tar", "pon"));
    ...
    public void reset(ActionEvent event) throws IOException {
        switchScene(event, "scenes/exercises/exercise2/exercise2_3.fxml");
    }
