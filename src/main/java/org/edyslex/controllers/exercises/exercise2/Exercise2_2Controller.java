...
public class Exercise2_2Controller extends ExerciseBaseController implements Initializable {
    ...
    public void reset(ActionEvent event) throws IOException {
        switchScene(event, "scenes/exercises/exercise2/exercise2_2.fxml");
    }
