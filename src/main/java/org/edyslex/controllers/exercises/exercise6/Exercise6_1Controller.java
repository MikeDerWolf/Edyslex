...
public class Exercise6_1Controller extends ExerciseBaseController implements Initializable {
    ...
    private List<List<String>> syllables = Arrays.asList(
            Arrays.asList("pă", "tu", "ră"),
            Arrays.asList("mă", "tu", "ră"),
            Arrays.asList("ra", "mu", "ră"),
            Arrays.asList("că", "ma", "șă"),
            Arrays.asList("ma", "și", "nă"),
            Arrays.asList("că", "mi", "lă")
        );
    ...
    public void reset(ActionEvent event) throws IOException {
        switchScene(event, "scenes/exercises/exercise6/exercise6_1.fxml");
    }
