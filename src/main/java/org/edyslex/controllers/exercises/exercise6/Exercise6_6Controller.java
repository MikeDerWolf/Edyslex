...
public class Exercise6_6Controller extends ExerciseBaseController implements Initializable {
    ...
    private List<List<String>> syllables = Arrays.asList(
            Arrays.asList("țân", "țar"),
            Arrays.asList("mag", "net"),
            Arrays.asList("doc", "tor"),
            Arrays.asList("vâr", "tej"),
            Arrays.asList("cân", "tar"),
            Arrays.asList("țur", "țur"),
            Arrays.asList("țam", "bal"),
            Arrays.asList("zâm", "bet"),
            Arrays.asList("șam", "pon")
        );
    ...
    public void reset(ActionEvent event) throws IOException {
        switchScene(event, "scenes/exercises/exercise6/exercise6_6.fxml");
    }
