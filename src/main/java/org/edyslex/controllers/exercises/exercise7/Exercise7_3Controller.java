...
public class Exercise7_3Controller extends ExerciseBaseController implements Initializable {
    ...
    private List<String> tags = new ArrayList<String>(Arrays.asList(
            "Vi-țe-lul mă-nân-că fân.", "Ța-pul sa-re gar-dul.", "Pi-si-ca sa-re din că-ru-ță.",
            "Bu-bu-ru-za stă pe frun-ză.", "Că-țe-lul mă-nân-că un os.", "Ță-ra-nul fa-ce o că-pi-ță de fân."));
    ...
    public void initialize(URL arg0, ResourceBundle arg1){
        ...
        labelsMap.put(lbl1, "Că-țe-lul mă-nân-că un os.");
        labelsMap.put(lbl2, "Bu-bu-ru-za stă pe frun-ză.");
        labelsMap.put(lbl3, "Pi-si-ca sa-re din că-ru-ță.");
        labelsMap.put(lbl4, "Ța-pul sa-re gar-dul.");
        labelsMap.put(lbl5, "Ță-ra-nul fa-ce o că-pi-ță de fân.");
        labelsMap.put(lbl6, "Vi-țe-lul mă-nân-că fân.");
    ...
    public void reset(ActionEvent event) throws IOException {
        switchScene(event, "scenes/exercises/exercise7/exercise7_3.fxml");
    }
