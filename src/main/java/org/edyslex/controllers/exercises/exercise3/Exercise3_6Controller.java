...
public class Exercise3_6Controller extends ExerciseBaseController implements Initializable {
    ...
    private List<String> tags = new ArrayList<String>(Arrays.asList(
            "șo-fer", "și-ret", "pi-lot", "co-șar", "pa-loș", "me-dic", "co-coș", "mo-rar", "fă-raș"));
    ...
    public void initialize(URL arg0, ResourceBundle arg1){
        ...
        labelsMap.put(lbl1, "șo-fer");
        labelsMap.put(lbl2, "și-ret");
        labelsMap.put(lbl3, "pi-lot");
        labelsMap.put(lbl4, "co-șar");
        labelsMap.put(lbl5, "pa-loș");
        labelsMap.put(lbl6, "me-dic");
        labelsMap.put(lbl7, "co-coș");
        labelsMap.put(lbl8, "mo-rar");
        labelsMap.put(lbl9, "fă-raș");
    ...
    public void reset(ActionEvent event) throws IOException {
        switchScene(event, "scenes/exercises/exercise3/exercise3_6.fxml");
    }
