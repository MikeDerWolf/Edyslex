...
public class Exercise3_4Controller extends ExerciseBaseController implements Initializable {
    ...
    private List<String> tags = new ArrayList<String>(Arrays.asList(
            "tren", "drum", "plic", "trup", "preș", "plus", "clop", "praz", "stop", "dres", "plop", "stup"));
    ...
    public void initialize(URL arg0, ResourceBundle arg1){
        ...
        labelsMap.put(lbl1, "tren");
        labelsMap.put(lbl2, "drum");
        labelsMap.put(lbl3, "plic");
        labelsMap.put(lbl4, "trup");
        labelsMap.put(lbl5, "preș");
        labelsMap.put(lbl6, "plus");
        labelsMap.put(lbl7, "clop");
        labelsMap.put(lbl8, "praz");
        labelsMap.put(lbl9, "stop");
        labelsMap.put(lbl10, "dres");
        labelsMap.put(lbl11, "plop");
        labelsMap.put(lbl12, "stup");
    ...
    public void reset(ActionEvent event) throws IOException {
        switchScene(event, "scenes/exercises/exercise3/exercise3_4.fxml");
    }
