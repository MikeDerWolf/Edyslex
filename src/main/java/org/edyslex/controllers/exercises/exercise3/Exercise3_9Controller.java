...
public class Exercise3_9Controller extends ExerciseBaseController implements Initializable {
    ...
    private List<String> tags = new ArrayList<String>(Arrays.asList(
            "coa-că-ze", "coa-jă", "moa-ră", "roa-tă", "școa-lă", "sfoa-ră", "soa-re", "floa-re"));
    ...
    public void initialize(URL arg0, ResourceBundle arg1){
        ...
        labelsMap.put(lbl1, "coa-că-ze");
        labelsMap.put(lbl2, "coa-jă");
        labelsMap.put(lbl3, "moa-ră");
        labelsMap.put(lbl4, "roa-tă");
        labelsMap.put(lbl5, "școa-lă");
        labelsMap.put(lbl6, "sfoa-ră");
        labelsMap.put(lbl7, "soa-re");
        labelsMap.put(lbl8, "floa-re");
    ...
    public void reset(ActionEvent event) throws IOException {
        switchScene(event, "scenes/exercises/exercise3/exercise3_9.fxml");
    }
