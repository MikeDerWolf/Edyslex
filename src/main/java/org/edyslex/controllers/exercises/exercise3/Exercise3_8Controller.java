...
public class Exercise3_8Controller extends ExerciseBaseController implements Initializable {
    ...
    private List<String> tags = new ArrayList<String>(Arrays.asList(
            "tra-ge", "lin-ge", "un-ge", "stin-ge", "spar-ge", "șter-ge", "fri-ge", "smul-ge", "strân-ge"));
    ...
    public void initialize(URL arg0, ResourceBundle arg1){
        ...
        labelsMap.put(lbl1, "tra-ge");
        labelsMap.put(lbl2, "lin-ge");
        labelsMap.put(lbl3, "un-ge");
        labelsMap.put(lbl4, "stin-ge");
        labelsMap.put(lbl5, "spar-ge");
        labelsMap.put(lbl6, "șter-ge");
        labelsMap.put(lbl7, "fri-ge");
        labelsMap.put(lbl8, "smul-ge");
        labelsMap.put(lbl9, "strân-ge");
    ...
    public void reset(ActionEvent event) throws IOException {
        switchScene(event, "scenes/exercises/exercise3/exercise3_8.fxml");
    }
