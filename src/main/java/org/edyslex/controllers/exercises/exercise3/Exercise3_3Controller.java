...
public class Exercise3_3Controller extends ExerciseBaseController implements Initializable {
    ...
    private List<String> tags = new ArrayList<String>(Arrays.asList(
            "card", "port", "șort", "tort", "porc", "cârd", "turc", "cerc", "fard"));
    ...
    public void initialize(URL arg0, ResourceBundle arg1){
        ...
        labelsMap.put(lbl1, "card");
        labelsMap.put(lbl2, "port");
        labelsMap.put(lbl3, "șort");
        labelsMap.put(lbl4, "tort");
        labelsMap.put(lbl5, "porc");
        labelsMap.put(lbl6, "cârd");
        labelsMap.put(lbl7, "turc");
        labelsMap.put(lbl8, "cerc");
        labelsMap.put(lbl9, "fard");
    ...
    public void reset(ActionEvent event) throws IOException {
        switchScene(event, "scenes/exercises/exercise3/exercise3_3.fxml");
    }
