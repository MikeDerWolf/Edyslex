...
public class Exercise1_3Controller extends ExerciseBaseController implements Initializable {
    ...
    private List<String> tags = new ArrayList<String>(Arrays.asList(
            "ca", "pi", "se", "su", "ri", "pa", "pe", "pi", "pa", "ra", "ro", "cu"));
    ...
    public void initialize(URL arg0, ResourceBundle arg1){
        ...
        labelsMap.put(lbl1, "ca");
        labelsMap.put(lbl2, "pi");
        labelsMap.put(lbl3, "se");
        labelsMap.put(lbl4, "su");
        labelsMap.put(lbl5, "ri");
        labelsMap.put(lbl6, "pa");
        labelsMap.put(lbl7, "pe");
        labelsMap.put(lbl8, "pi");
        labelsMap.put(lbl9, "pa");
        labelsMap.put(lbl10, "ra");
        labelsMap.put(lbl11, "ro");
        labelsMap.put(lbl12, "cu");
    ...
    public void reset(ActionEvent event) throws IOException {
        switchScene(event, "scenes/exercises/exercise1/exercise1_3.fxml");
    }
