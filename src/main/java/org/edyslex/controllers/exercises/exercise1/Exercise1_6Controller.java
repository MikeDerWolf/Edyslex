...
public class Exercise1_6Controller extends ExerciseBaseController implements Initializable {
    ...
    private List<String> tags = new ArrayList<String>(Arrays.asList(
            "fă", "ca", "fa", "fo", "că", "fu", "pa", "fa", "ca", "pa", "cu", "co"));
    ...
    public void initialize(URL arg0, ResourceBundle arg1){
        ...
        labelsMap.put(lbl1, "fă");
        labelsMap.put(lbl2, "ca");
        labelsMap.put(lbl3, "fa");
        labelsMap.put(lbl4, "fo");
        labelsMap.put(lbl5, "că");
        labelsMap.put(lbl6, "fu");
        labelsMap.put(lbl7, "pa");
        labelsMap.put(lbl8, "fa");
        labelsMap.put(lbl9, "ca");
        labelsMap.put(lbl10, "pa");
        labelsMap.put(lbl11, "cu");
        labelsMap.put(lbl12, "co");
    ...
    public void reset(ActionEvent event) throws IOException {
        switchScene(event, "scenes/exercises/exercise1/exercise1_6.fxml");
    }
