...
public class Exercise1_4Controller extends ExerciseBaseController implements Initializable {
    ...
    private List<String> tags = new ArrayList<String>(Arrays.asList(
            "pă", "co", "pe", "că", "pă", "pi", "ro", "cu", "mu", "mă", "că", "mă"));
    ...
    public void initialize(URL arg0, ResourceBundle arg1){
        ...
        labelsMap.put(lbl1, "pă");
        labelsMap.put(lbl2, "co");
        labelsMap.put(lbl3, "pe");
        labelsMap.put(lbl4, "că");
        labelsMap.put(lbl5, "pă");
        labelsMap.put(lbl6, "pi");
        labelsMap.put(lbl7, "ro");
        labelsMap.put(lbl8, "cu");
        labelsMap.put(lbl9, "mu");
        labelsMap.put(lbl10, "mă");
        labelsMap.put(lbl11, "că");
        labelsMap.put(lbl12, "mă");
    ...
    public void reset(ActionEvent event) throws IOException {
        switchScene(event, "scenes/exercises/exercise1/exercise1_4.fxml");
    }
