...
public class Exercise9_4Controller extends ExerciseBaseController implements Initializable {
    ...
    private List<String> tags = new ArrayList<String>(Arrays.asList(
            "mo-tor", "soț", "nor", "to-por", "doc-tor", "șorț", "școa-lă", "oa-se", "oa-lă",
            "coa-că-ze", "coa-jă", "șoa-re-ce", "ra-ma", "ma-ca-ra", "far", "bas-ma", "pa-lat", "cal"));

    private List<String> wordsO = new ArrayList<String>(Arrays.asList(
            "mo-tor", "soț", "nor", "to-por", "doc-tor", "șorț"));

    private List<String> wordsOA = new ArrayList<String>(Arrays.asList(
            "școa-lă", "oa-se", "oa-lă", "coa-că-ze", "coa-jă", "șoa-re-ce"));

    private List<String> wordsA = new ArrayList<String>(Arrays.asList(
            "ra-ma", "ma-ca-ra", "far", "bas-ma", "pa-lat", "cal"));
    ...
    public void initialize(URL arg0, ResourceBundle arg1){
        ...
        labelsMap.put(lbl7, wordsOA);
        labelsMap.put(lbl8, wordsOA);
        labelsMap.put(lbl9, wordsOA);
        labelsMap.put(lbl10, wordsOA);
        labelsMap.put(lbl11, wordsOA);
        labelsMap.put(lbl12, wordsOA);
    ...
    public void reset(ActionEvent event) throws IOException {
        switchScene(event, "scenes/exercises/exercise9/exercise9_4.fxml");
    }
