...
public class Exercise9_5Controller extends ExerciseBaseController implements Initializable {
    ...
    private List<String> tags = new ArrayList<String>(Arrays.asList(
            "co-joc", "o-col", "moș", "joc", "cor-don", "copt", "doi-nă", "foi", "bu-toi",
            "ră-țoi", "doi-că", "oi-nă", "film", "ni-mic", "vis", "fin", "mic", "ti-mid"));

    private List<String> wordsO = new ArrayList<String>(Arrays.asList(
            "co-joc", "o-col", "moș", "joc", "cor-don", "copt"));

    private List<String> wordsOI = new ArrayList<String>(Arrays.asList(
            "doi-nă", "foi", "bu-toi", "ră-țoi", "doi-că", "oi-nă"));

    private List<String> wordsI = new ArrayList<String>(Arrays.asList(
            "film", "ni-mic", "vis", "fin", "mic", "ti-mid"));
    ...
    public void initialize(URL arg0, ResourceBundle arg1){
        ...
        labelsMap.put(lbl1, wordsO);
        labelsMap.put(lbl2, wordsO);
        labelsMap.put(lbl3, wordsO);
        labelsMap.put(lbl4, wordsO);
        labelsMap.put(lbl5, wordsO);
        labelsMap.put(lbl6, wordsO);
        labelsMap.put(lbl7, wordsOI);
        labelsMap.put(lbl8, wordsOI);
        labelsMap.put(lbl9, wordsOI);
        labelsMap.put(lbl10, wordsOI);
        labelsMap.put(lbl11, wordsOI);
        labelsMap.put(lbl12, wordsOI);
        labelsMap.put(lbl13, wordsI);
        labelsMap.put(lbl14, wordsI);
        labelsMap.put(lbl15, wordsI);
        labelsMap.put(lbl16, wordsI);
        labelsMap.put(lbl17, wordsI);
        labelsMap.put(lbl18, wordsI);
    ...
    public void reset(ActionEvent event) throws IOException {
        switchScene(event, "scenes/exercises/exercise9/exercise9_5.fxml");
    }
