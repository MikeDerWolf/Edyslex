...
public class Exercise9_3Controller extends ExerciseBaseController implements Initializable {
    ...
    private List<String> tags = new ArrayList<String>(Arrays.asList(
            "șir", "țin-tit", "pi-tic", "lin", "fin", "ri-si-pit", "ied", "lă-mâ-ie", "fier",
            "ie-pu-raș", "miez", "mie-re", "me-re", "de-vre-me", "vre-me", "e-lev", "se-cret", "șef"));

    private List<String> wordsI = new ArrayList<String>(Arrays.asList(
            "șir", "țin-tit", "pi-tic", "lin", "fin", "ri-si-pit"));

    private List<String> wordsIE = new ArrayList<String>(Arrays.asList(
            "ied", "lă-mâ-ie", "fier", "ie-pu-raș", "miez", "mie-re"));

    private List<String> wordsE = new ArrayList<String>(Arrays.asList(
            "me-re", "de-vre-me", "vre-me", "e-lev", "se-cret", "șef"));
    ...
    public void initialize(URL arg0, ResourceBundle arg1){
        ...
        labelsMap.put(lbl7, wordsIE);
        labelsMap.put(lbl8, wordsIE);
        labelsMap.put(lbl9, wordsIE);
        labelsMap.put(lbl10, wordsIE);
        labelsMap.put(lbl11, wordsIE);
        labelsMap.put(lbl12, wordsIE);
        labelsMap.put(lbl13, wordsE);
        labelsMap.put(lbl14, wordsE);
        labelsMap.put(lbl15, wordsE);
        labelsMap.put(lbl16, wordsE);
        labelsMap.put(lbl17, wordsE);
        labelsMap.put(lbl18, wordsE);
    ...
    public void reset(ActionEvent event) throws IOException {
        switchScene(event, "scenes/exercises/exercise9/exercise9_3.fxml");
    }
